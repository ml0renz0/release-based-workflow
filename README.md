...
1. Crearás una *release* inicial `v0.9.0` desde la rama *master*.
1. Protegerás las ramas críticas `master` y `develop`.
1. Abrirás una *PR* para añadir nueva funcionalidad a la rama *develop*.
1. Abrirás una *PR* para llevar los cambios en la rama *develop* a la rama *master*.
1. Añadirás notas de release y harás el *merge* sobre la rama *master*.
1. Publicarás la nueva *release* `v1.0.0` que incluye la nueva *feature*.
1. Arreglarás un *bug* en la rama *develop* y luego en *master*.
