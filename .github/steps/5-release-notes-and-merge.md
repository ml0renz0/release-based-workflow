...
7. Vuelve a poner _Target_ en `master`, que es donde quieres crear la etiqueta una vez fusionada la rama de release.  
...
### :keyboard: Actividad: fusionar a `master`

1. En otra pestaña, abre la página **Pull requests** del repositorio.  
2. Entra en tu PR **[RELEASE] - 0.9.0#1.0.0**.  
